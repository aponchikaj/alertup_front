          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-md p-4">
              ...
              >
                ...
                {/* Nodes Layer */}
                <svg className="absolute inset-0" style={{ width: '100%', height: '600px' }}>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="font-medium text-blue-900">{selectedNode.label}</p>
                  </div>
                  <div>
                    <p className="text-sm text-blue-700">Type</p>
                    <p className="font-medium text-blue-900 capitalize">{selectedNode.type}</p>
                  </div>
                  <div>
                    <p className="text-sm text-blue-700">Position</p>
                    <p className="font-medium text-blue-900">({selectedNode.x}, {selectedNode.y})</p>
                  </div>
                  <div>
                    <p className="text-sm text-blue-700">Connections</p>
                    <p className="font-medium text-blue-900">{selectedNode.connections.length} nodes</p>
                  </div>
                </div>
                <button
