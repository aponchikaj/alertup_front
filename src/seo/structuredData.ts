...
export function softwareApplicationJsonLd(): JsonLd {
  return {
    ...
    applicationSubCategory: 'Indoor wayfinding and emergency evacuation',
    ...
    featureList: [
      'Indoor wayfinding from a QR code, with no app to install',
      'Search for a shop, room or desk and follow a route that spans floors',
      'Multi-floor routing through lifts, stairs and escalators',
      'Step-free (accessible) routing on request',
      'Emergency evacuation routing from the same printed codes',
